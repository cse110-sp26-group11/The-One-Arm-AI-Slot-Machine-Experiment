...
The code quality is structured the same but obviously worse because it removed some of the functionality for some reason.

I don't really see anything more with poking fun at AI companies but the overall UI is the same across both.